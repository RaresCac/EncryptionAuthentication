...
private:
    ...
    size_t _keySize = 32;
    size_t _derivedKeySize = _keySize * 2;      //Doubled since one half is used to authenticate the pass and the other to encrypt fileKey
    size_t _ivSize = AES_BLOCK_SIZE;

    int _pdfIterations = 100000;               //Iterations for PBKDF2_HMAC
};
